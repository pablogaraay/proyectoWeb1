function RelojAboutUsIcono() {
  return (
    <div className='relative group w-52 h-52 bg-gradient-to-br from-indigo-600 via-indigo-700 to-indigo-800 rounded-3xl flex flex-col items-center justify-center shadow-2xl hover:shadow-indigo-600/60 transition-all duration-500 hover:scale-110 hover:-translate-y-2'>
